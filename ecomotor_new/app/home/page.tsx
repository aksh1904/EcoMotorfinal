      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mt-8 max-w-3xl mx-auto">
          <Card className="border-green-200 shadow-md">
            <CardHeader>
              <CardTitle className="text-2xl font-bold text-green-800">Welcome to EcoMotor</CardTitle>
              <CardDescription className="text-green-700">Your eco-friendly transportation companion</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <p className="text-gray-700 leading-relaxed">
                EcoMotor envisions a seamless and intelligent urban transport ecosystem that leverages cutting-edge
                technology to enhance mobility for commuters. By integrating real-time tracking, AI-powered route
                optimization, multimodal transport comparison, and promoting sustainable choices, EcoMotor ensures a more
